  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: ForwardLit
    {
      ...
      OUT_Data_Vert vert(appdata_t in_v)
      {
          ...
          out_v.texcoord.zw = float2(0.0, 0.0);
          ...
          u_xlat16_4.x = u_xlat18 * in_v.tangent.w;
          ...
          u_xlat16_2.yzw = max(u_xlat16_4.xyz, float3(0.0, 0.0, 0.0));
          
          u_xlat16_4.x = dot(u_xlat16_2, float4(4.0, 3.0, 2.0, 1.0));
          ...
          u_xlat3.xyz = u_xlat0.yyy * _MainLightWorldToShadow[(u_xlati18 + 1)].xyz;
          
          u_xlat3.xyz = _MainLightWorldToShadow[u_xlati18].xyz * u_xlat0.xxx + u_xlat3.xyz;
          
          u_xlat3.xyz = _MainLightWorldToShadow[(u_xlati18 + 2)].xyz * u_xlat0.zzz + u_xlat3.xyz;
          
          out_v.texcoord3.xyz = u_xlat3.xyz + _MainLightWorldToShadow[(u_xlati18 + 3)].xyz;
          ...
          u_xlat16_22 = (-_AmbientClamp) + 1.0;
          
          u_xlat16_4.xyz = min(u_xlat16_4.xyz, float3(u_xlat16_22));
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_0_d = textureLod(hlslcc_zcmp_MainLightShadowmapTexture, txVec0, 0.0);
          
          u_xlat16_1.x = (-_MainLightShadowParams.x) + 1.0;
          
          u_xlat16_1.x = u_xlat16_0_d * _MainLightShadowParams.x + u_xlat16_1.x;
          
          u_xlatb0 = 0.0>=in_f.texcoord3.z;
          
          u_xlatb5 = in_f.texcoord3.z>=1.0;
          ...
          u_xlat16_0_d = texture(_DetailMap, in_f.texcoord.xy, _GlobalMipBias.x).w;
          
          u_xlat0_d.xyz = float3(u_xlat16_0_d) * u_xlat16_1.xyz;
          
          u_xlat16_2_d.xyz = texture(_BumpMap, in_f.texcoord.xy, _GlobalMipBias.x).xyz;
          
          u_xlat16_1.xyz = u_xlat16_2_d.xyz * float3(2.0, 2.0, 2.0) + float3(-1.0, -1.0, -1.0);
          
          u_xlat2_d.xyz = u_xlat16_1.yyy * in_f.texcoord2.xyz;
          
          u_xlat2_d.xyz = u_xlat16_1.xxx * in_f.texcoord1.xyz + u_xlat2_d.xyz;
          
          u_xlat2_d.xyz = u_xlat16_1.zzz * in_f.vs_NORMAL0.xyz + u_xlat2_d.xyz;
          ...
          u_xlat15 = dot(u_xlat2_d.xyz, _MainLightPosition.xyz);
          
          u_xlat15 = clamp(u_xlat15, 0.0, 1.0);
          
          u_xlat0_d.xyz = u_xlat0_d.xyz * float3(u_xlat15) + in_f.texcoord4.xyz;
          
          u_xlat16_1 = texture(_BaseMap, in_f.texcoord.xy, _GlobalMipBias.x);
          
          u_xlat1_d = u_xlat16_1 * _BaseColor;
          
          u_xlat0_d.xyz = u_xlat0_d.xyz * u_xlat1_d.xyz;
          
          out_f.color.w = u_xlat1_d.w;
          
          u_xlat16_3.xyz = min(u_xlat0_d.xyz, float3(65504.0, 65504.0, 65504.0));
          
          u_xlat16_4_d.xyz = (-u_xlat16_3.xyz) + _CoverColor.xyz;
          
          out_f.color.xyz = _CoverColor.www * u_xlat16_4_d.xyz + u_xlat16_3.xyz;
